...
You can also run `docker ps` from the command line.
====
...
https://github.com/BroadleafCommerce/MicroservicesStarter/tree/master/docs/Application_Provisioning.adoc[Creating an Application]
...
SSL cert first.
e.g. https://localhost:8447/content/default-hero.jpg?contextRequest=%7B%22forceCatalogForFetch%22:false,%22applicationId%22:%222%22,%22tenantId%22:%225DF1363059675161A85F576D%22%7D

Once you've accepted the cert, try refreshing the page and the browser should proceed to load the images.
