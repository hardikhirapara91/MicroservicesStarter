...
[TIP]
====
You can disable running the example tests in this project by running `mvn clean install -DskipTests`
====
+
...
====
+
4. Next, you will want to start up the core backend commerce APIs by running the following command:
+
[source,shell script]
----
mvn spring-boot:run
----
+
5. That's it! Once you've verified that the supporting services and backend APIs are running, you can visit
