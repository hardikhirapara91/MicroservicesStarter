...
This project provides a reference of how to utilize the
https://www.broadleafcommerce.com/microservices[Broadleaf Microservices Framework]
to help accelerate your application development.

It is intended to give you a hands on look at core concepts and extension patterns as well
